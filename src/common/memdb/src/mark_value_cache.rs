...
impl MarkValueCache {
    pub fn new() -> Self {
        Self {
            // When 65 tickers was given to YF websocket, in 20 seconds, 58 unique tickers received prices (which is OK, because if there is no trade, then no update is given).
